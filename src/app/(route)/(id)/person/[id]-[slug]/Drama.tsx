...
const Drama = ({ data, heading }: any) => {
  ...
  const sortedCast = filteredCast?.sort((a: any, b: any) => {
  ...
  const castLength = sortedCast?.length || 0;
