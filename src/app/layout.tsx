...
export const metadata: Metadata = {
  ...
  description:
    "Discover the best Asian dramas and movies at MijuDramaInfo. Explore comprehensive information about Chinese dramas, Korean dramas, Japanese dramas, Thai dramas, and more. Get detailed cast profiles, ratings, reviews, and streaming recommendations for thousands of shows.",
