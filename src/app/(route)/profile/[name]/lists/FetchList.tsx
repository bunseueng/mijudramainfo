...
const FetchList: React.FC<FetchRecentListProps> = ({
  tvId,
  movieId,
  index,
  handleMouseEnter,
  ...
  return (
    <li
      key={index}
      className="w-[92px] h-[128px] -mr-[35px] relative"
      ...
      <div className="flex absolute top-0 left-0">
        {isLoading || !item?.poster_path ? (
          ...
          <Image
            ...
            height={200}
            quality={100}
            className="block rounded-md w-[92px] h-[138px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:scale-110 transform duration-300 cursor-pointer"
          />
        )}
      </div>
    </li>
