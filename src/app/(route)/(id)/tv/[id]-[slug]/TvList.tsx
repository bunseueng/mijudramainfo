        ...
        {hovered === "Overview" && (
          ...
          >
            <ul className="text-black py-2">
              ...
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/cover`}>
                  Cover Image
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/related`}>
                  Related Titles
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/cast`}>
                  Cast Credits
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/crew`}>
                  Crew Credits
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/genres`}>
                  Genres
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
              ...
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/release`}>
                  Release Information
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/services`}>
                  Services
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/external_link`}>
                  External Links
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/edit/production`}>
        ...
        {(hovered === "Media" || hovered === "Videos") && (
          ...
          >
            <ul className="relative text-black py-2">
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={false} href={`/tv/${tv_id}/photos`}>
                  Photos{" "}
                ...
                {hovered === "Videos" && (
                  <div className="w-[150px] md:w-[200px] absolute top-7 left-6 md:-top-10 md:left-full bg-white border-[1px] border-[#00000026] shadow-md rounded-md mt-2">
                    <ul className="py-2">
                      ...
                      <Link prefetch={false} href={`/tv/${tv_id}/videos/clips`}>
                        <li className="text-xs md:text-basehover:bg-[#f8f9fa] py-1 px-2 md:px-6 cursor-pointer">
                          Clips
                        </li>
                      </Link>
        ...
        {hovered === "Fandom" && (
          ...
          >
            <ul className="text-black py-2">
              ...
              <Link prefetch={false} href={`/tv/${tv_id}/reviews`}>
                <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                  Reviews
                </li>
              </Link>
