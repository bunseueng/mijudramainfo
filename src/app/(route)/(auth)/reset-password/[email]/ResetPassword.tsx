...
const ResetPassword = ({ params }: { params: { email: string } }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#242526] p-8 rounded shadow-md w-96 mt-[100px] mb-[300px] max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-4">
          ...
          <div className="relative">
            <div className="md-pt-3 w-1/12  bg-opacity-50 flex items-center justify-center absolute right-2 top-4 dark:bg-navy-600">
              {visible ? (
                <FaEye
