...
import { fetchBatchTv, fetchMongoTVDrama } from "@/app/actions/fetchMovieApi";
import HomeCard from "../Card/HomeCard";
import { HomeDramaT } from "../Main/Section";

const MongoTVDrama = ({ heading, getDrama, existingRatings }: HomeDramaT) => {
  const { data, isLoading: isTrendingLoading } = useQuery({
    queryKey: ["MongoTVDrama"],
    queryFn: fetchMongoTVDrama,
    staleTime: 3600000,
