        ...
        {hovered === "Overview" && (
          ...
          >
            <ul className="text-black py-2">
              ...
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/edit/cover`}>
                  Cover Image
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/edit/related`}>
                  Related Titles
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/edit/cast`}>
                  Cast Credits
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/edit/crew`}>
                  Crew Credits
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/edit/genres`}>
                  Genres
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
              ...
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/edit/release`}>
                  Release Information
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/edit/services`}>
                  Services
                </Link>
              </li>
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
        ...
        {(hovered === "Media" || hovered === "Videos") && (
          ...
          >
            <ul className="relative text-black py-2">
              <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                <Link prefetch={true} href={`/movie/${movie_id}/photos`}>
                  Photos{" "}
        ...
        {hovered === "Fandom" && (
          ...
          >
            <ul className="text-black py-2">
              ...
              <Link prefetch={true} href={`/movie/${movie_id}/reviews`}>
                <li className="text-sm hover:bg-[#f8f9fa] py-1 px-6 cursor-pointer">
                  Reviews
                </li>
              </Link>
