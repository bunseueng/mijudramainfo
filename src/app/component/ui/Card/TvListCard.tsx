...
import FetchRecentList from "@/app/(route)/profile/[name]/lists/FetchRecentList";

const TvListCard: React.FC<IList> = ({ list }) => {
  ...
  return (
    <div className="mt-1">
      <div className="">
        {list
          ?.sort((a: any, b: any) => b?.love - a?.love)
          ?.slice(0, 4)
          ?.map((listItem: any, listIndex: number) => (
