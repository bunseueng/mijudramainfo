...
const Discuss = ({ user, users, tv_id, getComment }: any) => {
  ...
  return (
    <div className="py-5">
      <div className="min-h-[100px] relative bg-[#242526] text-[#ffffffde] border-2 border-[#00000024] shadow-sm rounded-sm mb-2">
              ...
              <div className="text-left block mb-1">
                <div className="relative inline-block w-full align-bottom text-md">
                  <textarea
                    ...
                    className="w-full h-[53.6px] min-h-[53.6px] bg-[#3a3b3c] border-2 border-[#46494a] focus:border-blue-500 focus:ring-blue-500 text-[#ffffffcc] text-sm font-normal rounded-sm outline-none focus:transform focus:duration-300 py-2 px-4"
          ...
          <ul>
            {getComment
              ...
              .map((comment: any, idx: number) => (
                <li
                  className="relative border-t-2 border-t-[#36383a] -mx-[12px] pt-4 px-4"
                  key={idx}
                >
                  <CommentCard
                    comment={comment}
